...
--
-- Table structure for table `Bestell_Liste`
--

DROP TABLE IF EXISTS `Bestell_Liste`;
...
CREATE TABLE `Bestell_Liste` (
  ...
  CONSTRAINT `Bestell_Liste_ibfk_1` FOREIGN KEY (`Ersteller`) REFERENCES `webapplication_user` (`username`),
  CONSTRAINT `Bestell_Liste_chk_1` CHECK ((`Menge` >= 0))
