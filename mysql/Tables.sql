...
CREATE TABLE `Achievements` (
    ...
    `Bestell_Achievement_1` TINYINT DEFAULT 0,
    `Bestell_Achievement_2` TINYINT DEFAULT 0,
    `Bestell_Achievement_3` TINYINT DEFAULT 0,
    `Lager_Count` INT DEFAULT 0,
    `Lager_Achievement_1` TINYINT DEFAULT 0,
    `Lager_Achievement_2` TINYINT DEFAULT 0,
    `Lager_Achievement_3` TINYINT DEFAULT 0,
    `Rueckgabe_Count` INT DEFAULT 0,
    `Rueckgabe_Achievement_1` TINYINT DEFAULT 0,
    `Rueckgabe_Achievement_2` TINYINT DEFAULT 0,
    `Rueckgabe_Achievement_3` TINYINT DEFAULT 0,
    `Handout_Count` INT DEFAULT 0,
    `Handout_Achievement_1` TINYINT DEFAULT 0,
    `Handout_Achievement_2` TINYINT DEFAULT 0,
    `Handout_Achievement_3` TINYINT DEFAULT 0,
    PRIMARY KEY(`id`),
