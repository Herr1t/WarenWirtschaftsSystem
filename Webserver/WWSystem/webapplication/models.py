...
class Achievements(models.Model):
    ...
    bestell_achievement_1 = models.IntegerField(db_column='Bestell_Achievement_1')
    bestell_achievement_2 = models.IntegerField(db_column='Bestell_Achievement_2')
    bestell_achievement_3 = models.IntegerField(db_column='Bestell_Achievement_3')
    lager_count = models.IntegerField(db_column='Lager_Count')
    lager_achievement_1 = models.IntegerField(db_column='Lager_Achievement_1')
    lager_achievement_2 = models.IntegerField(db_column='Lager_Achievement_2')
    lager_achievement_3 = models.IntegerField(db_column='Lager_Achievement_3')
